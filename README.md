...
About this web app: Car Custom Builder is an interactive web application that allows users to design and customize their own car by selecting various features, options, and add-ons. 
...
<img src="./client/assets/codepath_WEB103_unit3.gif" title="Video Walkthrough" width="600" alt="Video Walkthrough" />
